...
const { title: bookName, author: authorName, libraryID: bookId } = book2;
console.log(`The title of the book is ${bookName}, the author is ${authorName}, and the library id is ${bookId}`);
